...
def replace_layers(model: nn.Module, replace_rms_norm: bool = False):
    for module in model.modules():
        if isinstance(module, LlamaRMSNorm) and replace_rms_norm:
...
def main() -> None:
    ...
    # Add NPURMSNorm
    parser.add_argument("--fused_rms_norm", action="store_true", default=False)
    ...
    if args.fused_rms_norm and IS_NPU_AVAILABLE:
        replace_layers(model, args.fused_rms_norm)
    ...
    # whether the model is sharded or not (only test for 1.3b)
